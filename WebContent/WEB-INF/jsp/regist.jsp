...
<script>
	function checkForm() {
		...
		//首子符为大写
		if ((username.charAt(0).charCodeAt(0) < 65)
				|| (username.charAt(0).charCodeAt(0) > 90)) {
			alert("输入的首字符必须是大写字母");
			return false;
		}
		// 校验密码:
						...
						<table>
							<tbody>
								<tr>
									...
									<td><form:input path="username" id="username" class="text"
											maxlength="20" onblur="checkUsername()" /> <span id="span1"
										style="padding-left: 10px;"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
									<td><form:password path="password" id="password"
											name="password" class="text" maxlength="20" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><form:input path="email" id="email" class="text"
											maxlength="20" /> <form:errors path="email" cssClass="error" />
									</td>
								</tr>
								<tr>
									<th>姓名:</th>
									<td><form:input path="name" class="text" maxlength="200" /></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>年龄:</th>
									<td><form:input path="age" id="age" class="text"
											type="number" min="1" maxlength="3" /></td>
								</tr>
								<tr>
									<th>电话:</th>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											onclick="changeImg()" title="点击更换验证码" /></span> <c:if
											test="${errorCheckCode !=null}">
